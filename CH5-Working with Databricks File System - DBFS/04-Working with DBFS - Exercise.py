...
# MAGIC %md
# MAGIC #####2. Show contents of a dbfs directory inside the root using the following approaches
# MAGIC 1. With dbfs qualifier
# MAGIC 2. Without dbfs qualifier
...
# MAGIC %md
# MAGIC #####3. Show content of the local file system
...
# MAGIC %md
# MAGIC #####4. Show all mounted loations
