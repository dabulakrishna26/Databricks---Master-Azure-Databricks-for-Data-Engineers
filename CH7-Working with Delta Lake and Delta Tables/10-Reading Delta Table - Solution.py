...
# MAGIC URL 'abfss://dbfs-container@prashantsa.dfs.core.windows.net/external'
# MAGIC WITH (CREDENTIAL `scholarnest-storage-credential`)
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS dev.demo_db.flight_time_ext_tbl (
# MAGIC     FL_DATE DATE, 
...
# MAGIC     DISTANCE INT
# MAGIC ) USING DELTA
# MAGIC LOCATION "abfss://dbfs-container@prashantsa.dfs.core.windows.net/external/flight-time"

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from dev.demo_db.flight_time_ext_tbl
